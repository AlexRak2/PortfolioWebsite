  ...
  return (
    <section id="projects" className="w-full z-10 h-full bg-custom-gray-900">
          ...
          <p className="text-2xl lg:text-2xl sm:text-xl  text-white font-black">
            ...
            <Project title="Easy Desk" skills="ASP.NET - C# - React" link="https://github.com/AlexRak2/EasyDesk" imgUrl="https://private-user-images.githubusercontent.com/56671393/369593385-4dd38619-8f92-42bd-9ac7-5f5a8c93c642.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..juWvwjHDCnJR6DOyHlVEl_pxpmAUDf40wPt41YF7vp4" 
                description="An industry task management system built with ASP.NET and React.">
